        ...
        <div class="row">
            <div class="col">
                ...
                <?php if(!empty(session()->getFlashdata('fail'))) : ?>
                    <div class="alert-danger"> <?= session()->getFlashdata('fail');?></div>
                <?php endif ?>
                ...
                <div class="input-control">
                        ...
                        <input type="text" placeholder="Enter name:" name="name" class="input-field" value="<?= set_value('name'); ?> ">
                        <span class="text-danger"><?= isset($validation) ? display_error($validation,'name') : '' ?></span>
                    </div>
                    <div class="input-control">
                        <label for="">Email</label>
                        <input type="text" placeholder="Enter Email:" name="email" class="input-field" value="<?= set_value('email'); ?>">
                        <span class="text-danger"><?= isset($validation) ? display_error($validation,'email') : '' ?></span>
                    </div>
                    <div class="input-control">
                        <label for="">Password</label>
                        <input type="password" placeholder="Enter pass:" name="password" class="input-field" value="<?= set_value('password'); ?>">
                        <span class="text-danger"><?= isset($validation) ? display_error($validation,'password') : '' ?></span>
                    </div>
                    <div class="input-control">
                        <label for="">confirm Password</label>
                        <input type="password" placeholder="confirm pass:" name="cpassword" class="input-field" value="<?= set_value('cpassword'); ?>">
...
<head>
    <meta charset="UTF-8">
    <title>Vinsafe — Virtual Business solutions Projects    </title>
...
<header>
    ...
    <div class="menu" >
        <ul>
            ...
            <li class="menu-item hidden"><a href="https://vinsafesolution.com/services">SERVICES</a>
            </li>
            <li class="menu-item hidden"><a href="https://vinsafesolution.com/projects">PROJECTS</a></li>
...
<section class="wrapper">
    <div class="heading">
        ...
        <p class="text text-normal">Register an account to continue
				</p>
    </div>
    <form class="form" action="<?= base_url('auth/save'); ?>" method="post" autocomplete="off">
                <?= csrf_field(); ?>
                ...
                <div class="input-control">
                        <label class="input-label" for="" hidden>Name</label>
                        <input class="input-field" type="text" placeholder="Name" name="name"  value="<?= set_value('name'); ?>">
                        <span class="text-danger"><?= isset($validation) ? display_error($validation,'name') : '' ?></span>
                    </div>
                    <div class="input-control">
                        <label class="input-label" for="" hidden>Email</label>
                        <input class="input-field" type="text" placeholder="Email" name="email"  value="<?= set_value('email'); ?>">
                        <span class="text-danger"><?= isset($validation) ? display_error($validation,'email') : '' ?></span>
                    </div>
                    <div class="input-control">
                        <label class="input-label" for=""hidden>Password</label>
                        <input class="input-field" type="password" placeholder="Password" name="password"  value="<?= set_value('password'); ?>">
                        <span class="text-danger"><?= isset($validation) ? display_error($validation,'password') : '' ?></span>
                    </div>
                    <div class="input-control">
                        <label class="input-label" for="" hidden>confirm Password</label>
                        <input class="input-field" type="password" placeholder="Confirm Password" name="cpassword"  value="<?= set_value('cpassword'); ?>">
                        <span class="text-danger"><?= isset($validation) ? display_error($validation,'cpassword') : '' ?></span>
                    </div>
                    <div class="input-control">
